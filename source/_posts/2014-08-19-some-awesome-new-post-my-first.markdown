---
layout: post
title: "Some Awesome New Post: My First"
date: 2014-08-19 00:03:15 +1000
comments: true
categories:
published: false
---
...
If you use the fabulous [Sublime Text 2/3 editor][ST] along with the [Markdown Preview plugin][MarkdownPreview], open your ST2 Palette with `CTRL+⇧+P` then choose `Markdown Preview in browser` to see the result in your browser.
